...
function ListboxPretty(props){
  ...
  return (
    <Listbox
      ...
      onChange={props.setSelectedFilter}
    >
      {({ open }) => (
        <>
          ...
          <div className="relative">
            ...
            >
              ...
              >
                {props.filters.map((person) => (
                  <Listbox.Option key={person.id} value={person}>
                    {({ selected, active }) => (
                      <div className={`${active ? "text-white bg-blue-600" : "text-gray-900"} cursor-default select-none relative py-2 px-4`}>
